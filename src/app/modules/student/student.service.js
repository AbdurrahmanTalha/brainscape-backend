...
var joinCourseService = function (userId, courseId) { return __awaiter(void 0, void 0, void 0, function () {
    var user, course, obj, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                obj = { courseId: courseId, progress: [] };
                return [4 /*yield*/, student_model_1.default.findByIdAndUpdate(user.student, {
                        $push: {
                            courses: obj,
                        },
                    }, {
...
var leaveCourseService = function (userId, courseId) { return __awaiter(void 0, void 0, void 0, function () {
    var user, course, obj, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_model_1.default.findById(userId)];
...
exports.default = { joinCourseService: joinCourseService, leaveCourseService: leaveCourseService };
